...
|---------|--------|--------|---------|
| **v2.0.0-rc1** | `main` | 🧪 Release Candidate | [v2.0.0-rc1](https://github.com/freddewitt/CorbeauSplat/releases/tag/v2.0.0-rc1) |
| **v1.5.1** | `v1` | ✅ Stable (legacy) | [v1.5.1](https://github.com/freddewitt/CorbeauSplat/releases/tag/v1.5.1) |
...
⚠️ **Release candidate**: feature-complete, awaiting real-world validation before 2.0.0. For production use, stay on the `v1` branch (v1.5.1).
